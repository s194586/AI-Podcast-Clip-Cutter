...
class ClipEvaluation(Base):
    ...
    quality_score: Mapped[float | None] = mapped_column(Float, default=0.0, nullable=True)
    context_score: Mapped[float | None] = mapped_column(Float, default=0.0, nullable=True)
    hook_score: Mapped[float | None] = mapped_column(Float, default=0.0, nullable=True)
    payoff_score: Mapped[float | None] = mapped_column(Float, default=0.0, nullable=True)
    boundary_score: Mapped[float | None] = mapped_column(Float, default=0.0, nullable=True)
    privacy_risk: Mapped[str | None] = mapped_column(String(32), default="low", index=True, nullable=True)
    ...
    crop_advice: Mapped[str | None] = mapped_column(String(64), default="keep_current", nullable=True)
    needs_more_context: Mapped[bool | None] = mapped_column(Boolean, default=False, nullable=True)
